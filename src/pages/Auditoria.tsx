...
const tipoOptions = [
  ...
  { value: "licitacion", label: "Oportunidad" },
  { value: "licitacion_archivo", label: "Archivo de oportunidad" },
  { value: "licitacion_comentario", label: "Comentario de oportunidad" },
  { value: "licitacion_historial", label: "Historial de oportunidad" },
  { value: "licitacion_cotizacion", label: "Cotizacion vinculada a oportunidad" },
